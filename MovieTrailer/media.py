...
import webbrowser
class Movie():
    """This si the movie class, which allows for other classes to build objects from it."""
...
# Creates a method "show_trailer" method that allows for other classes to send teh data here and then view the trailer in the web browser.
